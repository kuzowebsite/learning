...
?>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				<h1>Холбоо барих</h1>
				<span>Бидэнтэй холбогдоорой</span>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
						...
						<h3>Бидэнд имэйл илгээнэ үү</h3>
							...
							<form class="nobottommargin" id="template-contactform" name="template-contactform" action="" method="post">
								...
								<div class="col_one_third">
									<label for="template-contactform-name">Нэр <small>*</small></label>
								...
								<div class="col_one_third">
									<label for="template-contactform-email">Имэйл <small>*</small></label>
								...
								<div class="col_one_third col_last">
									<label for="template-contactform-phone">Утас</label>
								...
								<div class="col_full">
									<label for="template-contactform-message">Захиа <small>*</small></label>
					...
					<div class="sidebar col_last nobottommargin">
						...
						<address>
							<strong>Оффис:</strong><br>
							Монгол Улаанбаатар Идэр их сургууль<br>
						</address>

						<abbr title="Phone Number"><strong>Утас:</strong></abbr> 1234-5678<br>
						<abbr title="Email Address"><strong>Имэйл:</strong></abbr> ider@ider.edu.mn
