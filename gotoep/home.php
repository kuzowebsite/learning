	...
	<div id="wrapper" class="clearfix">
		...
		<div id="vertical-nav">
			<div class="container clearfix">
				...
				<nav>
					<ul>
						<li class="current"><a href="home.php"><i class="icon-home2"></i></a>Нүүр</li>

                        <li><a href="categorie.php"><i class="icon-book2"></i>Ангилал</a></li>

						<li><a href="courses.php"><i class="icon-book3"></i>Курсууд</a></li>

						<li><a href="content.php"><i class="icon-line-content-left"></i>Агуулга</a> </li>

						<li><a href="blog.php"><i class="icon-blogger"></i>Блог</a></li>

						<li><a href="library.php"><i class="icon-line-align-center"></i>Номын сан</a></li>

						<li><a href="instructors.php"><i class="icon-guest"></i>Багш</a></li>

                        <li><a href="team.php"><i class="icon-users"></i>Баг</a></li>

                        <li><a href="logout.php"><i class="icon-line-power"></i>Гарах</a></li>    
        ...
        <section id="page-title" style="margin-padding: 0px;">
            ...
            <div class="container clearfix">
                <h1>Тавтай морил <strong><?php if(isset($loginName)) echo $loginName; ?></strong></h1>
            </div>
			...
			<div class="content-wrap">
                ...
                <?php
                 ...
                 ?>
						...
						<h3>Админыг оруулна уу</h3>

                        <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="nameId">Бүтэн нэр</label>
                    ...
                    <div class="form-group">                    
                       <label>Админ төрөл</label>
                        <select class="form-control"  name="admin_op">
                        <option value="">Сонголтыг сонгоно уу</option>
                        <option value="yes">Тиймээ боловсронгуй</option>
                        <option value="no">Боловсроогүй</option>
                        </select>
                    ...
                    <div class="form-group">
                        <label for="passwordId1">Нууц үг</label>
                    ...
                    <div class="form-group">
                        <label for="passwordId2">Нууц үгээ баталгаажуулна уу</label>
